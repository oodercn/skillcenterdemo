...
public class ExecutionController {
     ...
     */
    @GetMapping("/stats")
    public ResponseEntity<ApiResponse<SkillExecutionStats>> getExecutionStats() {
    ...
    public ResponseEntity<ApiResponse<SkillResult>> executeSkill(@PathVariable String skillId, @RequestBody ExecuteSkillRequest request) {
    ...
    public ResponseEntity<ApiResponse<String>> executeSkillAsync(@PathVariable String skillId, @RequestBody ExecuteSkillRequest request) {
        String executionId = UUID.randomUUID().toString();
    ...
    public ResponseEntity<ApiResponse<SkillResult>> getExecutionResult(@PathVariable String executionId) {
        SkillResult result = executionResults.get(executionId);
        if (result == null) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(ApiResponse.notFound("Execution result not found"));
        }
        return ResponseEntity.ok(ApiResponse.success(result));
    }
    ...
    public ResponseEntity<ApiResponse<String>> getExecutionStatus(@PathVariable String executionId) {
        SkillResult result = executionResults.get(executionId);
        if (result == null) {
    ...
    public ResponseEntity<ApiResponse<Boolean>> clearExecutionResult(@PathVariable String executionId) {
     ...
     */
    @GetMapping("/history")
    public ResponseEntity<ApiResponse<Map<String, SkillResult>>> getExecutionHistory() {
        return ResponseEntity.ok(ApiResponse.success(executionResults));
    }
