...
public class SystemController {
     ...
     */
    @PutMapping("/config")
    public ResponseEntity<ApiResponse<Map<String, Object>>> updateSystemConfig(@RequestBody Map<String, Object> config) {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> shutdownSystem() {
        Map<String, Object> result = new HashMap<>();
     ...
     */
    @DeleteMapping("/cache")
    public ResponseEntity<ApiResponse<Map<String, Object>>> clearSystemCache() {
        Map<String, Object> result = new HashMap<>();
    ...
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> getSystemOperations() {
     ...
     */
    @GetMapping("/logs")
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> getSystemLogs(@RequestParam(required = false) String level) {
     ...
     */
    @DeleteMapping("/logs")
    public ResponseEntity<ApiResponse<Map<String, Object>>> clearSystemLogs() {
        Map<String, Object> result = new HashMap<>();
